  ...
  const handleSingleUpload = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await setDoc(doc(db, 'certificates', certId), {
        ...
        studentName: singleData.studentName.trim(),
        certificateNumber: singleData.certificateNumber.trim(),
        issueDate: new Date().toISOString(),
        imageUrl,
        ipfsHash: pinataResult.IpfsHash,
        tokenId: tokenId || null,
        txHash: txHash || null,
        studentWalletAddress: walletAddress || null,
        createdBy: user.uid,
    ...
    try {
      ...
      for (const item of csvData) {
        ...
        const metadata = {
          ...
          image: imageUrl,
          attributes: [
            { trait_type: "Nama Mahasiswa", value: item.studentName },
            { trait_type: "Nomor Ijazah", value: item.certificateNumber },
            { trait_type: "Lembaga Penerbit", value: "UPN 'Veteran' Yogyakarta" },
            { trait_type: "Tanggal Terbit", value: new Date().toISOString() }
          ]
        };
        ...
        await setDoc(doc(db, 'certificates', certId), {
          ...
          tokenId: tokenId || null,
          txHash: txHash || null,
          studentWalletAddress: rawRecipient || null,
          createdBy: user.uid,
          mintedAt: serverTimestamp(),
          isDigitalOnly: !txHash,
        });
          ...
          {activeMode === 'single' ? (
              ...
              <form onSubmit={handleSingleUpload} className="grid md:grid-cols-2 gap-x-6 gap-y-4">
                ...
                <div className="md:col-span-2 space-y-1.5">
                  ...
                  <input 
                    ...
                    placeholder="0x..."
                    className="w-full px-4 py-3 bg-stone-50 border border-stone-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#2196F3] transition-all font-mono text-xs"
                  />
                </div>
            ...
            <div className="space-y-6">
              <div className="p-6 bg-white rounded-2xl border border-stone-200 shadow-sm transition-all hover:shadow-md">
                ...
                <p className="text-sm text-stone-500 mb-6">Upload file CSV berisi data mahasiswa. Kolom wajib: studentEmail, studentName, certificateNumber, imageFileName. Kolom opsional: studentWalletAddress.</p>
